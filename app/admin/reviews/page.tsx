        ...
        {reviews.map((review) => (
          <Card key={review.id}>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <form action={convertReviewToUseCase}><input type="hidden" name="id" value={review.id} /><button type="submit" className="rounded-lg bg-ink px-3 py-2 text-sm text-white active:scale-95 active:opacity-70 transition-all">使用例に変換</button></form>
