...
export const aiTools: AiTool[] = [
  ...
  { id: "supabase", name: "Supabase", category: "データベース・Webアプリ基盤", description: "AI診断サイトやWebアプリで、診断結果・投稿・使用例・ユーザーデータなどを保存するためのデータベース基盤です。", beginnerFriendly: false, officialUrl: "https://supabase.com/", isAffiliate: false, tags: ["診断ログ保存", "使用感投稿DB", "AIツールDB", "Webアプリのデータ管理", "認証", "ストレージ"] }
];
